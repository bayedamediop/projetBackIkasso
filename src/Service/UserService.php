...
class UserService
{
     ...
     */
    private ProfilsRepository  $profilRepository;
    /**
     ...
     * @param ProfilsRepository $profilRepository
     * @param ValidatorInterface $validator
     */
    public function __construct( UserPasswordEncoderInterface $encoder,SerializerInterface $serializer, ProfilsRepository $profilRepository,ValidatorInterface $validator)
    {
